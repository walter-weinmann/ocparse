...
"MATCH variable_9 = ( ( { parameter_1 } ) <- [ ? ] -> ( ) ) , ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( )". 
"MATCH ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( ) , variable_9 = ( ( ( ) <- -> ( ) ) )".
"MATCH variable_9 = ( ( ( variable_1 ) - -> ( ) ) ) , ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( )".
"MATCH ( ) <- -> ( ) , variable_9 = ( ( ( : node_1 ) <- - ( ) ) )".
"MATCH variable_9 = ( ( ( : node_1 : node_2 ) - - ( ) ) ) , ( ) <- -> ( )".
...
"MATCH variable_9 = ( ( ( { } ) <- [ ] - ( ) ) ) , ( { } ) <- [ ] - ( )".
"MATCH ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( ) , variable_9 = ( ( ( { property_key_1 : nOt 'test_1' .property_1 :label_1 is null oR 'test_1' .property_1 :label_1 is null } ) - [ ] - ( ) ) )".
"MATCH ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( ) , variable_9 = ( ( ( { parameter_1 } ) <- [ ? ] -> ( ) ) ) , ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( )". 
"MATCH variable_9 = ( ( ( { 4711 } ) <- [ : rel_type_1 ] -> ( ) ) ) , ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( )".
"MATCH ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( ) , variable_9 = ( ) <- -> ( )".
"MATCH variable_9 = ( variable_1 ) - -> ( ) , ( variable_1 { } ) <- [ : rel_type_1 | : rel_type_1 ] -> ( )".
"MATCH ( ) <- -> ( ) , variable_9 = ( : node_1 ) <- - ( )".
"MATCH variable_9 = ( ( ( { 4711 } ) <- [ : rel_type_1 ] -> ( ) ) ) , variable_9 = ( variable_1 : node_1 ) <- [ ] -> ( )".
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% shortest_path_pattern = ALL( pattern_element )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
