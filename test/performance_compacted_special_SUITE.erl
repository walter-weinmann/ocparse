...
test_compacted(_Config) ->
    ...
    {ok, _} = ocparse:source_to_pt("Merge variable_1 = (variable_2) On Create Set variable_3 = [variable_4 In variable_5                        ]"),
    {ok, _} = ocparse:source_to_pt("Merge variable_1 = (variable_2) On Create Set variable_3 = [variable_4 In variable_5            | variable_6]"),
    {ok, _} = ocparse:source_to_pt("Merge variable_1 = (variable_2) On Create Set variable_3 = [variable_4 In variable_5 Where True             ]"),
    {ok, _} = ocparse:source_to_pt("Merge variable_1 = (variable_2) On Create Set variable_3 = [variable_4 In variable_5 Where True | variable_6]"),
    ok.
