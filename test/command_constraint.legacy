...
"CREATE CONSTRAINT ON ( variable_1 : node_1 ) ASSERT EXISTS ( 'Dies\" ist \"ein String' .Property_key_4711 )".
...
"CREATE CONSTRAINT ON (movie:Movie) ASSERT exists ( 4711 .Property_key_4711)".
...
"DROP CONSTRAINT ON ( variable_1 : node_1 ) ASSERT EXISTS ( 'Dies\" ist \"ein String' .Property_key_4711 )".
...
"DROP CONSTRAINT ON (movie:Movie) ASSERT exists ( 4711 .Property_key_4711)".
...
"CREATE CONSTRAINT ON () - [ variable_1 : relation_1 ] -> () ASSERT exists ( 'Dies\" ist \"ein String' .Property_key_4711 )".
"CREATE CONSTRAINT ON () - [ variable_1 : relation_1 ] - () ASSERT exists ( 'Dies\" ist \"ein String' .Property_key_1 )".
"CREATE CONSTRAINT ON () - [ variable_1 : relation_1 ] - () ASSERT exists ( 4711 .Property_key_4711)".
...
"DROP CONSTRAINT ON () - [ variable_1 : relation_1 ] -> () ASSERT exists ( 'Dies\" ist \"ein String' .Property_key_4711 )".
"DROP CONSTRAINT ON () - [ variable_1 : relation_1 ] - () ASSERT exists ( 'Dies\" ist \"ein String' .Property_key_1 )".
"DROP CONSTRAINT ON () - [ variable_1 : relation_1 ] - () ASSERT exists ( 4711 .Property_key_4711)".
