...
createUniqueConstraint : CREATE ws uniqueConstraint ;

createNodePropertyExistenceConstraint : CREATE ws nodePropertyExistenceConstraint ;

createRelationshipPropertyExistenceConstraint : CREATE ws relationshipPropertyExistenceConstraint ;
...
uniqueConstraint : CONSTRAINT sp ON ws '(' variable nodeLabel ')' ASSERT propertyExpression IS sp UNIQUE ;

nodePropertyExistenceConstraint : CONSTRAINT sp ON ws '(' variable nodeLabel ')' ASSERT sp EXISTS '(' propertyExpression ')' ;

relationshipPropertyExistenceConstraint : CONSTRAINT sp ON ws relationshipPatternSyntax ASSERT sp EXISTS '(' propertyExpression ')' ;
...
match : ( OPTIONAL sp )? MATCH ws pattern ( ws hint )* ( ws where )? ;
