...
-module(oclexer_legacy).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/oclexer_legacy.xrl", 39).
...
-file("src/oclexer_legacy.erl", 386).
yystate() -> 36.
...
yystate(38, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 41 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
...
yystate(36, [59|Ics], Line, Tlen, Action, Alen) ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(36, [48|Ics], Line, Tlen, Action, Alen) ->
...
yystate(36, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 42 ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(36, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
...
yystate(34, [10|Ics], Line, Tlen, _, _) ->
    yystate(42, Ics, Line+1, Tlen+1, 13, Tlen);
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(34, Ics, Line, Tlen+1, 13, Tlen);
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(34, Ics, Line, Tlen+1, 13, Tlen);
...
yystate(30, [10|Ics], Line, Tlen, _, _) ->
    yystate(22, Ics, Line+1, Tlen+1, 14, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 41 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 43 ->
    yystate(22, Ics, Line, Tlen+1, 14, Tlen);
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 95 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
...
yystate(25, [69|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line, Tlen+1, 5, Tlen);
yystate(25, [56|Ics], Line, Tlen, _, _) ->
    yystate(1, Ics, Line, Tlen+1, 5, Tlen);
yystate(25, [57|Ics], Line, Tlen, _, _) ->
    yystate(1, Ics, Line, Tlen+1, 5, Tlen);
yystate(25, [46|Ics], Line, Tlen, _, _) ->
    yystate(33, Ics, Line, Tlen+1, 5, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 55 ->
...
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 41 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
...
yystate(13, [69|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line, Tlen+1, 6, Tlen);
yystate(13, [56|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line, Tlen+1, 6, Tlen);
yystate(13, [57|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(9, [69|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line, Tlen+1, 7, Tlen);
yystate(9, [56|Ics], Line, Tlen, _, _) ->
    yystate(1, Ics, Line, Tlen+1, 7, Tlen);
yystate(9, [57|Ics], Line, Tlen, _, _) ->
    yystate(1, Ics, Line, Tlen+1, 7, Tlen);
yystate(9, [46|Ics], Line, Tlen, _, _) ->
    yystate(33, Ics, Line, Tlen+1, 7, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 55 ->
...
yystate(6, [48|Ics], Line, Tlen, _, _) ->
...
-file("src/oclexer_legacy.xrl", 6).
yyaction_0(TokenChars, TokenLine) ->
     { token, { 'EXPONENT_DECIMAL_REAL', TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/oclexer_legacy.xrl", 7).
yyaction_1(TokenChars, TokenLine) ->
     { token, { 'UNSIGNED_REGULAR_DECIMAL_REAL', TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/oclexer_legacy.xrl", 8).
yyaction_2(TokenChars, TokenLine) ->
     { token, { 'SIGNED_REGULAR_DECIMAL_REAL', TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/oclexer_legacy.xrl", 9).
yyaction_3(TokenChars, TokenLine) ->
     { token, { 'HEX_INTEGER', TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/oclexer_legacy.xrl", 10).
yyaction_4(TokenChars, TokenLine) ->
     { token, { 'UNSIGNED_OCTAL_INTEGER', TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("src/oclexer_legacy.xrl", 11).
yyaction_5(TokenChars, TokenLine) ->
     { token, { 'SIGNED_OCTAL_INTEGER', TokenLine, TokenChars } } .

-compile({inline,yyaction_6/2}).
-file("src/oclexer_legacy.xrl", 12).
yyaction_6(TokenChars, TokenLine) ->
     { token, { 'UNSIGNED_DECIMAL_INTEGER', TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("src/oclexer_legacy.xrl", 13).
yyaction_7(TokenChars, TokenLine) ->
     { token, { 'SIGNED_DECIMAL_INTEGER', TokenLine, TokenChars } } .

-compile({inline,yyaction_8/2}).
-file("src/oclexer_legacy.xrl", 14).
yyaction_8(TokenChars, TokenLine) ->
     { token, { 'DIGIT_STRING', TokenLine, TokenChars } } .

-compile({inline,yyaction_9/2}).
-file("src/oclexer_legacy.xrl", 17).
yyaction_9(TokenChars, TokenLine) ->
     { token, { 'ESCAPED_SYMBOLIC_NAME', TokenLine, TokenChars } } .

-compile({inline,yyaction_10/3}).
-file("src/oclexer_legacy.xrl", 18).
yyaction_10(TokenChars, TokenLen, TokenLine) ->
     match_any (TokenChars, TokenLen, TokenLine, ? TokenPatters) .

-compile({inline,yyaction_11/2}).
-file("src/oclexer_legacy.xrl", 21).
yyaction_11(TokenChars, TokenLine) ->
     { token, { 'STRING_LITERAL', TokenLine, TokenChars } } .

-compile({inline,yyaction_12/2}).
-file("src/oclexer_legacy.xrl", 22).
yyaction_12(TokenChars, TokenLine) ->
     { token, { 'STRING_LITERAL', TokenLine, TokenChars } } .

-compile({inline,yyaction_13/0}).
-file("src/oclexer_legacy.xrl", 25).
yyaction_13() ->
     skip_token .

-compile({inline,yyaction_14/0}).
-file("src/oclexer_legacy.xrl", 26).
yyaction_14() ->
     skip_token .

-compile({inline,yyaction_15/2}).
-file("src/oclexer_legacy.xrl", 29).
yyaction_15(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_16/2}).
-file("src/oclexer_legacy.xrl", 30).
yyaction_16(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_17/2}).
-file("src/oclexer_legacy.xrl", 31).
yyaction_17(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_18/2}).
-file("src/oclexer_legacy.xrl", 32).
yyaction_18(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_19/0}).
-file("src/oclexer_legacy.xrl", 35).
yyaction_19() ->
     skip_token .
